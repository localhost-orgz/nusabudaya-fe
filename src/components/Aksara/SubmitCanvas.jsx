...
const SubmitCanvas = ({ onCheck }) => {
  return (
    <aside className="w-full lg:w-1/4 order-3 flex flex-col space-y-3">
      <button 
          onClick={onCheck}
          className="flex w-full items-center justify-center gap-2 bg-(--color-secondary) hover:bg-(--color-secondary)/80 text-white py-4 rounded-lg font-bold shadow-lg shadow-(--color-secondary)/20 transition-all active:scale-95">
